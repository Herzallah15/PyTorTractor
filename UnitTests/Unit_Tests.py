...
sparsgrid_light = PyTor_SG_Perambulator(Path_Sparse_Grid ='../Data/sparse_perambs_ud.hdf5', LatticeExtent = (16, 16, 16) ,
                                        Device = device, Double_Reading = False, cplx128 = complex128)
sparsgrid_strange = PyTor_SG_Perambulator(Path_Sparse_Grid ='../Data/sparse_perambs_s.hdf5', LatticeExtent = (16, 16, 16) ,
                                        Device = device, Double_Reading = False, cplx128 = complex128)
Sparsgrids = {'Light': sparsgrid_light, 'Strange': sparsgrid_strange, 'Charm': None}
modeDoublet         = PyTor_MDoublet(Path_ModeDoublet = '../Data/mode_doublets_1.hdf5', Device = device, cplx128 = complex128)
modeTriplet         = PyTor_MTriplet(Path_ModeTriplet = '../Data/mode_triplets_1_compact.hdf5', Compressed = True, nEv = 4, Device = device, cplx128 = complex128)
epsilon_small = 1e-14
...
string = '<Corr>{J kaon P=[0,0,0] T1u_3 SS_0} {isodoublet_kaon_pion T1u_3 P=[0,0,1] A2 SS_1 P=[0,0,-1] A2m SS_1}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 1)
hadrons = hadrons_info.get_Hadrons()

Wick_subpath = hadrons_info.get_Wickpath()

res = []
for t in range(8):
    test0 = PyCorrTorch(SinkTime = None, current_time = t, SourceTime = 0, Hadrons = hadrons, Path_Wicktract =  '../WickDiagrams/Basic_Tests.hdf5',
                        Wick_subpath = Wick_subpath)#'JK_KP')
    test0_contracted = test0.TorchTractor( All_Perambulators = perambulator, ModeDoublets = modeDoublet, ModeTriplets = None,
                                          all_SG_perambulators = Sparsgrids)
    res.append(test0_contracted)

Correct = [-0.00023658527441103693-7.390013485380287e-07j, -8.364107957979792e-07+8.200530535227632e-08j, -7.993185495373685e-07-3.264432375590413e-08j,
              -8.163999908061962e-08-5.751597507856915e-09j, -1.89765702615613e-08+4.712937570367348e-11j, -3.8483312342634245e-09-2.418436364594143e-10j,
              -4.157220657572774e-10-1.0699413470892057e-10j, -4.950965275478804e-11-6.906360913168019e-12j]
compare_c_results(res, Correct,epsilon_small)


# Test 2

string = '<Corr>{J pion P=[0,0,1] A2m_1 SS_1} {pion P=[0,0,1] A2m_1 SS_1}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = None)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
...
for t in range(8):
    test0 = PyCorrTorch(SinkTime = None, current_time = t, SourceTime = 0, Hadrons = hadrons, Path_Wicktract =  '../WickDiagrams/Basic_Tests.hdf5',
                        Wick_subpath = Wick_subpath)#'PJP')
    test0_contracted = test0.TorchTractor( All_Perambulators = perambulator, ModeDoublets = modeDoublet, ModeTriplets = None,
                                          all_SG_perambulators = Sparsgrids)
    res.append(test0_contracted)
C_Correct = [0.006754566340861884+7.465117483595845e-06j, 0.0006420686978543228-1.4918657109732992e-05j,
            0.00010933381102317717-4.966642356468202e-08j, 1.8172723438107964e-05-5.618372555425856e-07j,
            2.5570750477900745e-06-1.0506102115947952e-07j, 3.598648526359744e-07-8.991429271766276e-09j,
            5.0529942984135227e-08-1.3398291240746306e-09j, 6.898484298134832e-09-3.517686374429051e-10j]
compare_c_results(res, C_Correct,epsilon_small)



# Test 3

string = '<Corr>{J pion P=[0,0,0] A1um_1 SS_0} {pion P=[0,0,0] A1um_1 SS_0}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 0)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
res = []
for t in range(8):
    ...
    test0_contracted = test0.TorchTractor( All_Perambulators = perambulator, ModeDoublets = modeDoublet, ModeTriplets = None,
                                          all_SG_perambulators = Sparsgrids)
    res.append(test0_contracted)
C_Correct = [0.07288063996842328-4.890056499420716e-36j, 0.0073866793668884104+6.923661726343273e-36j, 
             0.001246843278744073+8.375397249608798e-38j, 0.00019967596121779225+4.904015494836731e-38j,
            2.9209905091878982e-05-2.4333536622612734e-38j, 4.2975627560170755e-06-2.963129680722685e-39j,
            6.100323606256931e-07-2.0340127469367585e-40j, 8.666428002646869e-08-2.105759228310189e-40j]
...
string = '<Corr>{phi P=[0,0,0] A1gp_1 SS_0} {phi P=[0,0,0] A1gp_1 SS_0}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 0)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
...
res = []
for t in range(8):
    test0 = PyCorrTorch(SinkTime = t, SourceTime = 0, Hadrons = hadrons, Path_Wicktract =  '../WickDiagrams/Basic_Tests.hdf5',
                        Wick_subpath = Wick_subpath)#'Phi_Phi')
...
string = '<Corr>{eta P=[0,0,0] A1gp_1 SS_0} {eta P=[0,0,0] A1gp_1 SS_0}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 0)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
res = []
for t in range(8):
    test0 = PyCorrTorch(SinkTime = t, SourceTime = 0, Hadrons = hadrons, Path_Wicktract =  '../WickDiagrams/Basic_Tests.hdf5',
                        Wick_subpath = Wick_subpath)#'Eta_Eta')
    test0_contracted = test0.TorchTractor( All_Perambulators = perambulator, ModeDoublets = modeDoublet, ModeTriplets = modeTriplet)
    res.append(test0_contracted)
...
string = '<Corr>{eta P=[0,0,0] A1gp_1 SS_0} {phi P=[0,0,0] A1gp_1 SS_0}</Corr>' 
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 0)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
res = []
...
for t in range(8):
    test0 = PyCorrTorch(SinkTime = t, SourceTime = 0, Hadrons = hadrons, Path_Wicktract =  '../WickDiagrams/Basic_Tests.hdf5',
    Wick_subpath = Wick_subpath)#'Eta_Phi')
    test0_contracted = test0.TorchTractor( All_Perambulators = perambulator, ModeDoublets = modeDoublet, ModeTriplets = modeTriplet)
    res.append(test0_contracted)
...
string = '<Corr>{eta P=[0,0,0] A1gp_1 SS_0} {isosinglet_kaon_kbar A1gp_1 P=[0,0,0] A1u SS_0 P=[0,0,0] A1u SD_1}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 0)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
res = []
for t in range(8):
    test0 = PyCorrTorch(SinkTime = t, SourceTime = 0, Hadrons = hadrons, Path_Wicktract =  '../WickDiagrams/Basic_Tests.hdf5',
                        Wick_subpath = Wick_subpath)#EtaIsosingletKKc')
    test0_contracted = test0.TorchTractor( All_Perambulators = perambulator, ModeDoublets = modeDoublet, ModeTriplets = modeTriplet)
    res.append(test0_contracted)
...
string = '<Corr>{phi P=[0,0,0] A1gp_1 SS_0} {isosinglet_kaon_kbar A1gp_1 P=[0,0,0] A1u SS_0 P=[0,0,0] A1u SD_1}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 0)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
res = []
...
for t in range(8):
    test0 = PyCorrTorch(SinkTime = t, SourceTime = 0, Hadrons = hadrons, Path_Wicktract =  '../WickDiagrams/Basic_Tests.hdf5',
                        Wick_subpath = Wick_subpath)#'PhiIsosingletKKc')
    test0_contracted = test0.TorchTractor( All_Perambulators = perambulator, ModeDoublets = modeDoublet, ModeTriplets = modeTriplet)
    res.append(test0_contracted)
...
# Test 9
string = '<Corr>{isosinglet_kaon_kbar A1gp_1 P=[0,0,0] A1u SS_0 P=[0,0,0] A1u SS_0} {isosinglet_kaon_kbar A1gp_1 P=[0,0,0] A1u SS_0 P=[0,0,0] A1u SD_1}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 0)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
res = []
...
for t in range(8):
    test0 = PyCorrTorch(SinkTime = t, SourceTime = 0, Hadrons = hadrons, Path_Wicktract =  '../WickDiagrams/Basic_Tests.hdf5',
                        Wick_subpath = Wick_subpath)#isosingletKKC_isosingletKKC')
    test0_contracted = test0.TorchTractor( All_Perambulators = perambulator, ModeDoublets = modeDoublet, ModeTriplets = modeTriplet)
    res.append(test0_contracted)
...
string = '<Corr>{isosinglet_kaon_kbar A1gp_1 P=[0,0,0] A1u SS_0 P=[0,0,0] A1u SD_1} {isosinglet_kaon_kbar A1gp_1 P=[0,0,0] A1u SS_0 P=[0,0,0] A1u SS_0}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 0)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
res = []
...
# Test 11
string = '<Corr>{isosinglet_kaon_kbar A1p_1 P=[0,0,0] A1u SS_0 P=[0,0,1] A2 SS_0} {isosinglet_kaon_kbar A1p_1 P=[0,0,0] A1u SS_0 P=[0,0,1] A2 SS_0}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 0)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
...
string = '<Corr>{isosinglet_kaon_kbar A1gp_1 P=[0,0,0] A1u SS_0 P=[0,0,0] A1u SS_0} {isosinglet_kaon_kbar A1gp_1 P=[0,0,0] A1u SS_0 P=[0,0,0] A1u SS_0}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 0)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
...
compare_c_results(res, C_Correct,1e-13)



# Test 12

string = '<Corr>{isodoublet_kaon_pion T1u_3 P=[0,0,1] A2 SS_1 P=[0,0,-1] A2m SS_1} {isodoublet_kaon_pion T1u_3 P=[0,0,1] A2 SS_0 P=[0,0,-1] A2m SS_1}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 1)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
res = []
for t in range(8):
    test0 = PyCorrTorch(SinkTime = t, SourceTime = 0, Hadrons = hadrons, Path_Wicktract =  '../WickDiagrams/Basic_Tests.hdf5',
                        Wick_subpath = Wick_subpath)#KPKPDoublet')
    test0_contracted = test0.TorchTractor( All_Perambulators = perambulator, ModeDoublets = modeDoublet, ModeTriplets = modeTriplet)
    res.append(test0_contracted)
...
# Test 13
string = '<Corr>{isodoublet_kaon_pion T1u_3 P=[0,0,1] A2 SS_0 P=[0,0,-1] A2m SS_1} {kaon P=[0,0,0] T1u_3 SS_0}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 1)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
res = []
for t in range(8):
    test0 = PyCorrTorch(SinkTime = t, SourceTime = 0, Hadrons = hadrons, Path_Wicktract =  '../WickDiagrams/Basic_Tests.hdf5',
                        Wick_subpath = Wick_subpath)#'IsoDoubletKP_K')
    test0_contracted = test0.TorchTractor( All_Perambulators = perambulator, ModeDoublets = modeDoublet, ModeTriplets = modeTriplet)
    res.append(test0_contracted)
...
string = '<Corr>{kaon P=[0,0,0] T1u_3 SS_0} {isodoublet_kaon_pion T1u_3 P=[0,0,1] A2 SS_1 P=[0,0,-1] A2m SS_1}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 1)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
res = []
for t in range(8):
    test0 = PyCorrTorch(SinkTime = t, SourceTime = 0, Hadrons = hadrons, Path_Wicktract =  '../WickDiagrams/Basic_Tests.hdf5',
                        Wick_subpath = Wick_subpath)#K_IsoDoubletKP')
    test0_contracted = test0.TorchTractor( All_Perambulators = perambulator, ModeDoublets = modeDoublet, ModeTriplets = modeTriplet)
    res.append(test0_contracted)
...
compare_c_results(res, Correct_011,epsilon_small)
...
string = '<Corr>{pion P=[0,0,0] T1up_3 SS_0} {isotriplet_pion_pion T1up_3 P=[0,0,1] A2m SS_1 P=[0,0,-1] A2m SS_1}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 0)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
...
for t in range(8):
    test0 = PyCorrTorch(SinkTime = t, SourceTime = 0, Hadrons = hadrons, Path_Wicktract =  '../WickDiagrams/Basic_Tests.hdf5',
                        Wick_subpath = Wick_subpath)#'P_IsotripletPP')
    test0_contracted = test0.TorchTractor( All_Perambulators = perambulator, ModeDoublets = modeDoublet, ModeTriplets = modeTriplet)
    res.append(test0_contracted)
...
compare_c_results(res, correct_results,epsilon_small)



string = '<Corr>{isoquartet_kaon_pion A1g_1 P=[0,0,0] A1u SS_0 P=[0,0,0] A1um SS_0} {isoquartet_kaon_pion A1g_1 P=[0,0,0] A1u SS_0 P=[0,0,0] A1um SS_0}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 1)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
res = []
for t in range(8):
    test0 = PyCorrTorch(SinkTime = t, SourceTime = 0, Hadrons = hadrons, Path_Wicktract =  '../WickDiagrams/Basic_Tests.hdf5',
                        Wick_subpath = Wick_subpath)#Isoquartetkpkp')
    test0_contracted = test0.TorchTractor( All_Perambulators = perambulator, ModeDoublets = modeDoublet, ModeTriplets = modeTriplet)
    res.append(test0_contracted)
...
string = '<Corr>{lambda P=[0,0,0] G1u_1 SS_0} {isosinglet_kbar_nucleon G1u_1 P=[0,0,0] A1u SS_0 P=[0,0,0] G1g SS_0}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 1)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
res = []
for t in range(7):
    test0 = PyCorrTorch(SinkTime = t, SourceTime = 0, Hadrons = hadrons, Path_Wicktract =  '../WickDiagrams/Basic_Tests.hdf5',
                        Wick_subpath = Wick_subpath)#'SingletLKN')
    test0_contracted = test0.TorchTractor( All_Perambulators = perambulator, ModeDoublets = modeDoublet, ModeTriplets = modeTriplet)
    res.append(test0_contracted)
...
string = '<Corr>{isosinglet_kbar_nucleon G1u_1 P=[0,0,0] A1u SS_0 P=[0,0,0] G1g SS_0} {lambda P=[0,0,0] G1u_1 SS_0}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 0)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
...
for t in range(7):
    test0 = PyCorrTorch(SinkTime = t, SourceTime = 0, Hadrons = hadrons, Path_Wicktract =  '../WickDiagrams/Basic_Tests.hdf5',
                        Wick_subpath = Wick_subpath)#SingletKCNL')
    test0_contracted = test0.TorchTractor( All_Perambulators = perambulator, ModeDoublets = modeDoublet, ModeTriplets = modeTriplet)
    res.append(test0_contracted)
...
string = '<Corr>{isotriplet_pion_pion T1up_3 P=[0,0,1] A2m SS_1 P=[0,0,-1] A2m SS_1} {isotriplet_pion_pion T1up_3 P=[0,0,1] A2m SS_1 P=[0,0,-1] A2m SS_1}</Corr>'

hadrons_info = Hadrons_from_Strings(string = string, strangeness = 0)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
...
for t in range(7):
    test0 = PyCorrTorch(SinkTime = t, SourceTime = 0, Hadrons = hadrons, Path_Wicktract =  '../WickDiagrams/Basic_Tests.hdf5',
                        Wick_subpath = Wick_subpath)#'Isotripletpppp')
    test0_contracted = test0.TorchTractor( All_Perambulators = perambulator, ModeDoublets = modeDoublet, ModeTriplets = modeTriplet)
    res.append(test0_contracted)
...
string = '<Corr>{kaon P=[0,0,0] A1u_1 SS_0} {kaon P=[0,0,0] A1u_1 SS_0}</Corr>'
#dlen = 'dlen0'
hadrons_info = Hadrons_from_Strings(string = string, strangeness = 1)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
res = []
for t in range(5):
    test0 = PyCorrTorch(SinkTime = t, SourceTime = 0, Hadrons = hadrons, Path_Wicktract =  '../WickDiagrams/Basic_Tests.hdf5',
                        Wick_subpath = Wick_subpath)#K+K+B')
    test0_contracted = test0.TorchTractor( All_Perambulators = perambulator, ModeDoublets = modeDoublet, ModeTriplets = modeTriplet)
    res.append(test0_contracted)
...
string = '<Corr>{kaon P=[0,0,1] A2_1 SS_1} {kaon P=[0,0,1] A2_1 SS_1}</Corr>'
#dlen = 'dlen0'
hadrons_info = Hadrons_from_Strings(string = string, strangeness = 1)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
...
string = '<Corr>{kaon P=[0,0,0] A1u_1 SS_0} {kaon P=[0,0,0] A1u_1 SD_1}</Corr>'
#dlen = 'dlen0'
hadrons_info = Hadrons_from_Strings(string = string, strangeness = 1)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
...
string = '<Corr>{kaon P=[0,0,0] A1u_1 SD_1} {kaon P=[0,0,0] A1u_1 SD_1}</Corr>'
#dlen = 'dlen0'
hadrons_info = Hadrons_from_Strings(string = string, strangeness = 1)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
...
string = '<Corr>{kaon P=[0,0,0] A1u_1 SD_1} {kaon P=[0,0,0] A1u_1 SS_0}</Corr>'
#dlen = 'dlen0'
hadrons_info = Hadrons_from_Strings(string = string, strangeness = 1)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
...
string = '<Corr>{nucleon P=[0,0,0] G1g_1 SS_0} {nucleon P=[0,0,0] G1g_1 SS_0}</Corr>' 
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 0)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
res = []
...
string = '<Corr>{nucleon P=[0,0,0] G1g_2 SS_0} {nucleon P=[0,0,0] G1g_2 SS_0}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 0)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
...
string = '<Corr>{lambda P=[0,0,1] G2_1 SS_0} {lambda P=[0,0,1] G2_1 SS_0}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 0)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
...
for t in range(7):
    test0 = PyCorrTorch(SinkTime = t, SourceTime = 0, Hadrons = hadrons, Path_Wicktract =  '../WickDiagrams/Basic_Tests.hdf5',
                        Wick_subpath = Wick_subpath)#'L0L0')
    test0_contracted = test0.TorchTractor( All_Perambulators = perambulator, ModeDoublets = modeDoublet, ModeTriplets = modeTriplet)
    res.append(test0_contracted)
...
string = '<Corr>{lambda P=[0,0,1] G2_1 SD_12} {lambda P=[0,0,1] G2_1 SS_0}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen_left = 'dlen1', dlen_right = 'dlen0', strangeness = 0)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
...
string = '<Corr>{lambda P=[0,0,1] G2_1 SD_12} {lambda P=[0,0,1] G2_1 SD_12}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen_left = 'dlen1', dlen_right = 'dlen1', strangeness = 0)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
...
string = '<Corr>{pion P=[0,0,0] A1um_1 SS_0} {pion P=[0,0,0] A1um_1 SS_0}</Corr>'
hadrons_info = Hadrons_from_Strings(string = string, dlen = 'dlen0', strangeness = 0)
hadrons = hadrons_info.get_Hadrons()
Wick_subpath = hadrons_info.get_Wickpath()
...
for t in range(9):
    test0 = PyCorrTorch(SinkTime = t, SourceTime = 0, Hadrons = hadrons, Path_Wicktract =  '../WickDiagrams/Basic_Tests.hdf5',
                        Wick_subpath = Wick_subpath)#Pi+Pi+')
    test0_contracted = test0.TorchTractor( All_Perambulators = perambulator, ModeDoublets = modeDoublet, ModeTriplets = None)
...
string = '<Corr>{pion P=[0,0,1] A2m_1 SS_1} {pion P=[0,0,1] A2m_1 SS_1}</Corr>'
...
string = '<Corr>{sigma P=[0,0,0] A1gp_1 SS_0} {sigma P=[0,0,0] A1gp_1 SS_0}</Corr>'
...
Contractor = PyCorrTorch(SinkTime=4, SourceTime=0, Hadrons=hadrons, Path_Wicktract= '../WickDiagrams/Basic_Tests.hdf5',
                         Wick_subpath = Wick_subpath)#SigmaSigmaB')
...
test0            = PyCorrTorch(SinkTime = 4, SourceTime = 0, 
                               Hadrons = hadrons, Path_Wicktract =  '../WickDiagrams/Basic_Tests.hdf5',
                               Wick_subpath = Wick_subpath)#'Pi+Pi+')
test0_contracted = test0.TorchTractor( All_Perambulators = perambulator, ModeDoublets = modeDoublet, ModeTriplets = None)
...
perambulator        = {'Light': perambulators_light, 'Strange': None, 'Charm': None}
modeDoublet         = PyTor_MDoublet(Path_ModeDoublet = '../Data/mode_doublets_1.hdf5', Device = device, cplx128 = complex128)
modeTriplet_old         = PyTor_MTriplet(Path_ModeTriplet = '../Data/mode_triplets_1_compact.hdf5', Compressed = True, nEv = 4, Device = device, cplx128 = complex128)
modeTriplet = {}
for i in range(9):
